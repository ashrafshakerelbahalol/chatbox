...
public class ChatController {
    ...
    public ResponseEntity<?> createChat(@RequestBody AddingChatRequest chatRequest) {
        try {
            ...
            return ResponseEntity.status(500).body(new ApiResponse("The chat isnot created ", e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> addUserToChat(
        ...
        try {
            ...
            return ResponseEntity.status(500).body(new ApiResponse("The user is not added", e.getMessage()));
        }
    }
